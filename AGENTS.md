...
- **GitHub ve Versiyonlama:** Yapılan tüm geliştirmeler otomatik olarak GitHub depolarına commit edilip push edilecek, versiyon numaraları hassasiyetle takip edilecektir.
- **Standart Telefon ve Fax Formatı:** Tüm projelerde telefon, GSM ve fax numaraları her zaman `0(XXX) XXX XX XX` (Örn: `0(541) 608 53 44` veya `0(324) 233 00 00`) formatında maskelenecek, saklanacak ve görüntülenecektir.
